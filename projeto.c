...
int main (){ 
	...
	while (1) { // Cria um loop infinito que só será interrompido pelo comando break
        ...
        printf("2. Qual seu nome\n");
        printf("3. Diga Ola Mundo\n");
        printf("4. Soma\n");
        printf("5. calcule a media de nota\n");
        printf("6. Conversao de temperatura celsius para fahrenheit\n");
        printf("7. Conversao dolar a real\n");
        printf("8. Sair\n");
	...
	printf("A temperatura em fahrenheit sera: %f\n", fah);
			...
			printf("Quanto voce tem em dolar:\n");
	scanf("%f",&dolar);
	printf("qual o valor do dolar em real:\n");
	scanf("%f",&taxa);
	real = (dolar * taxa);
	printf("voce tem entao em real:%.2f\n", real);
